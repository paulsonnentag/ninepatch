      ...
      <Section
        ...
        prose={
          <p>
            ...
            fields are URLs. The listing below is <code>open("demo")</code>,
            live: it goes link → folder doc, and every entry you see is itself a
            link something below will follow.
          </p>
        }
      >
        <FolderView />
        ...
        prose={
          <>
            <p>
              ...
              below is mounted twice on the <b>same document</b>:
            </p>
            <pre>{`<Mount tool={Chat} mount={{ doc: seed.chat, user: seed.alice }} />
<Mount tool={Chat} mount={{ doc: seed.chat, user: seed.bob }} />`}</pre>
            <p>
              Two people in one page, one code path, no props. Rename them below
              — both panes re-render, because <code>user</code> is a link into a
              contact document and reads are live.
            </p>
          </>
        }
      >
      ...
      <Section
        ...
        prose={
          <p>
            ...
            <code>places</code> by deriving it from the canvas document:{" "}
            <code>{'frame.mount("places", derive(canvas, (d) => …))'}</code>.
            Give the third card coordinates (click it) and a pin appears.{" "}
      ...
      <Section
        ...
        prose={
          <>
            <p>
              One line in the host: <code>frame.mount("selection", null)</code>{" "}
              ...
              same handle. Current value: <SelectionValue />
            </p>
            <p>
              The second map below got a <b>private</b> selection —{" "}
              <code>
                {"<Mount tool={MapView} mount={{ selection: null }} />"}
              </code>{" "}
              shadows the shared one, so clicking here selects nothing anywhere
      ...
      <Section
        ...
        prose={
          <p>
            ...
            and the editor swaps documents live.
          </p>
        }
      >
        <div class="row">
